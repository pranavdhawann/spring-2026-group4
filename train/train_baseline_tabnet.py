...
Script to train TabNet-based text forecasting model.

This mirrors `train_baseline_finbert.py` but swaps the forecasting head for
`tabet_forcasting`, a TabNet-based architecture.
...
def convert_X_to_tensors(X, device="cpu"):
    input_ids = torch.stack([sample[0] for sample in X])
...
def train(train_config):
    config = {
        ...
        "experiment_path": "experiments/baseline/tabnetForecasting",
