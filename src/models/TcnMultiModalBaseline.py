...
class TCNEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        embedding_seq = self.projection(x)
...
if __name__ == "__main__":
    ...
    print("  Expected:     (32, 14, 256)")

    assert embedding.shape == (
        batch_size,
        14,
        256,
    ), f"Expected (32, 14, 256), got {embedding.shape}"
    print("Passed!")
    ...
    print(f"  Input shape:  {x.shape}")
    print(f"  Output shape: {embedding.shape}")
    print("  Expected:     (16, 14, 128)")

    assert embedding.shape == (
        16,
        14,
        128,
    ), f"Expected (16, 14, 128), got {embedding.shape}"
    print("Passed!")
    ...
    print(f"  Input shape:  {x.shape}")
    print(f"  Output shape: {embedding.shape}")
    print("  Expected:     (8, 14, 256)")

    assert embedding.shape == (
        8,
        14,
        256,
    ), f"Expected (8, 14, 256), got {embedding.shape}"
    print("Passed!")
    ...
    print("  Output: (batch_size, seq_len=14, embedding_size=256)")
